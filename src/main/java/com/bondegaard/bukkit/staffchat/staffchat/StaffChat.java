...
public class StaffChat implements CommandExecutor {
    ...
    protected String message = Main.getInstance().getConfig().getString("StaffChat-Format");
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        Bukkit.getOnlinePlayers().stream().filter(onlinePlayer -> onlinePlayer.hasPermission("staffchat.use")).forEach(onlinePlayer ->
        {
